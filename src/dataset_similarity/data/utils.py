...
def get_embedding_path(
    ...
    Args:
        ...
        data_dir: An absolute path to the root directory of the original dataset. This
            ...
            `dataset_similarity.constants.DEFAULT_DATA_DIR`, but can be overridden if
    ...
    Returns:
        Path: The absolute path where the embedding for the image can be saved or
            loaded.
    """
    return embedding_dir / image_path.relative_to(data_dir).with_suffix(".safetensors")
